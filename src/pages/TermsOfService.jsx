    ...
    <div className="min-h-screen bg-[#FAEECF] text-black py-16">
      <div className="max-w-3xl mx-auto px-4 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>
            JabNGo connects fighters with potential sparring partners. You agree
            to use the service only for lawful purposes and to treat all users
            respectfully.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            JabNGo is provided “as is” without warranties of any kind. We do not
            guarantee specific results from sparring matches or user
            interactions.
          </p>
        </section>
