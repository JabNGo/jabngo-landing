...
import "../App.css"; // Ensure this imports your CSS variables
        ...
        <div className="max-w-3xl mx-auto px-4 space-y-10">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Email address:</strong> to notify you about our launch
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              technologies to collect usage data. You can disable cookies in
